...
void ClapTrap::attack(std::string const &target)
{
	...
	{
		std::cout << "ClapTrap has 0 HP" << std::endl;
		return ;
	}
	if (this->energy_points == 0)
	{
		std::cout << "ClapTrap has 0 energy points" << std::endl;
		return ;
	}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << "ClapTrap " << this->name << " was repaired by " << amount << " of HP. Current HP:" << this->hit_points << std::endl;
	this->energy_points--;
}
...
void ClapTrap::takeDemage(unsigned int amount)
{
	if (amount > this->hit_points)
		...
		this->hit_points -= amount;
	std::cout << "ClapTrap " << this->name << " recived " << amount << " of points of damage. Current HP:" << this->hit_points << std::endl;
}